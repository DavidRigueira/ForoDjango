...
urlpatterns = [
    ...
    re_path(r'^settings/password/done/$', auth_views.PasswordChangeDoneView.as_view(template_name='password_change_done'
                                                                                              '.html'),
    ...
    re_path(r'^boards/(?P<pk>\d+)/new_category/$', views.new_category, name='new_category'),
    re_path(r'^points/$', views.PointsListView.as_view(), name='points_user'),
